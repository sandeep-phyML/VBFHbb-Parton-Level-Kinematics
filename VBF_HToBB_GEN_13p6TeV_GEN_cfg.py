...
# with command line options: Configuration/GenProduction/python/VBF_HToBB_GEN_fragment_13_6_annote.py --python_filename VBF_HToBB_GEN_13p6TeV_GEN_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:VBF_HToBB_GEN_13p6TeV_GEN.root --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step LHE,GEN --era Run3 --mc --no_exec -n 100
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/VBF_HToBB_GEN_fragment_13_6_annote.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:VBF_HToBB_GEN_13p6TeV_GEN.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:VBF_HToBB_GEN_13p6TeV_GEN_inLHE.root'),
